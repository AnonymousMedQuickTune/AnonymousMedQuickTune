...
%------------------------------------------------------------------------------
    ...
    \usepackage{parskip}  % Remove paragraph indentation, add space between paragraphs instead
    ...
    \usepackage[sort&compress,numbers]{natbib} % citet, citep
...
% https://colorbrewer2.org/#type=qualitative&scheme=Paired&n=11 Cynthia Brewer
